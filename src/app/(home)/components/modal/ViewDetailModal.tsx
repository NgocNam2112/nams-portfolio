    ...
    <Dialog open={modalOpen} onOpenChange={setModalOpen}>
      <DialogTrigger asChild>
        <div className="relative w-fit mx-auto">
          <Button className="p-0 h-auto w-auto rounded-full hover:bg-transparent group hover:shadow-lg text-white font-semibold button-hover theme-transition-colors">
            <div
      ...
      >
        ...
        <DialogFooter>
          <div className="flex px-6 pb-4 justify-between gap-4">
            <Button
              onClick={() => {
                setModalOpen(false);
              }}
